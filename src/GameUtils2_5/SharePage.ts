...
class SharePage extends egret.DisplayObjectContainer
{
    ...
    private desctext: string = '盛讯小游戏--封神名册';
    ...
    private getWeiXinShareTimeline() {
        ...
        bodyMenuShareTimeline.link = 'http://sjlrecard.h5.gamexun.com/';
        bodyMenuShareTimeline.imgUrl = 'http://sjlrecard.h5.gamexun.com/shareicon.png';
    ...
    private getWeiXinShareAppMessage(){
        ...
        bodyMenuShareAppMessage.title = '盛讯小游戏--封神名册';
        bodyMenuShareAppMessage.desc = this.desctext;
        bodyMenuShareAppMessage.link = 'http://sjlrecard.h5.gamexun.com/';
        bodyMenuShareAppMessage.imgUrl = 'http://sjlrecard.h5.gamexun.com/shareicon.png';
